...
export const menuItems_default = [
  {
    isHeadr: true,
    title: "menu",
  },
...
export const menuItems = [
  { isHeadr: true, title: "ADMIN DASHBOARD" },
  // {
  //   title: "Dashboard",
  //   icon: "heroicons-outline:home",
  //   isOpen: true,
  ...
  },
  {
    ...
    isOpen: true,
    isHide: true,
    link: "/dashboard/financemanagement",
  },
];

export const menuItemsUser = [
  { isHeadr: true, title: "USER DASHBOARD" },
  {
    title: "Templates",
