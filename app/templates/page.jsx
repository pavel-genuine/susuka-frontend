...
const PrebuidTemplatesPage = () => {
 ...
 const results = templates.filter((obj) =>
    Object.values(obj).some(
      (value) =>
        Array.isArray(value) &&
       setSearchedTemplates(()=> value?.filter((nestObj) =>
       Object.values(nestObj).some(
         (nestValue) =>
           typeof nestValue === "string" &&
           nestValue.toLowerCase().includes(searchText?.toLowerCase())
       )
     ))
    )
  );
    ...
    <div className="w-[100%]">
      ...
      >
        ...
        >
          <Icon
            ...
            vFlip={undefined}
          />
          <p className="text-[16px] font-semibold text-white ml-[10px]">All</p>
        </div>
        ...
        >
          <Icon
            ...
            vFlip={undefined}
          />
          <p className="text-[16px] font-semibold text-[grey] ml-[10px]">Ads</p>
        </div>
      ...
      <div className=" w-[90%] mx-auto">
        {templates?.map((item) => (
          <div key={item?.id}>
           {
            (searchText || selectedTag =='Popular' || selectedTag == 'Favorite') ?
           ''
          : <p
          id={item?.category}
