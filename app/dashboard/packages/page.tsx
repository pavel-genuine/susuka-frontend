...
const Packages = () => {
    const COLUMNS: Column<IUser>[] = [
...

        {
            ...
            Cell: (row) => {
                return (
                    row?.cell?.value && (
                        <img
                            className="w-[100px] h-[100px] mr-20 rounded"
                            src={row?.cell?.value}
                            alt=""
                        />
                    )
            ...
            Cell: (row) => {
                return (
                    <p className="text-sm  text-center text-slate-600  dark:text-slate-300 capitalize w-[100px]">
                        {row?.cell?.value
                            ? new Date(row?.cell?.value)?.toDateString()
                            : ''}
                    </p>
                );
            },
        ...
        },
        {
            ...
            Cell: (row) => {
                return (
                    <span>{row?.cell?.value ? row?.cell?.value : '--'}</span>
                );
            },
        },
        {
    ...
    const COLUMNS2: Column<IUser>[] = [
        ...
        {
            Header: <p className="text-[red]">New Attribute</p>,
            accessor: 'new',
            Cell: (row) => {
                return (
                    <span>{row?.cell?.value ? row?.cell?.value : '--'}</span>
    ...
    const handleClickOpenAttribute = () => {
    ...
    const handleAddPlan = async () => {
        ...
        setTimeout(() => {
            dispatch(
                planCreate({ ...newPlan, planFeatures: features.split('*') })
            );
        }, 2000);
    };
    ...
    const handleUpdatePlan = async () => {
        const res = await updatePlan(selectedId, {
            ...updatedPlan,
            planFeatures: ['ff1', 'fff2', 'ff3', 'ff4'],
        });
        console.log(res, 'res');
    };
    ...
    const tableInstance = useTable(
        {
            columns: openAttribute ? columns2 : columns,
                    ...
                    {Object.keys(selectedRowIds).length ? (
                        <div className="flex space-x-5">
                            ...
                            <Button
                                ...
                                variant="contained"
                                onClick={handleClickOpenAttribute}
                            >
                                Add Attribute
                            </Button>
                        </div>
            ...
            <Card noborder>
                <div className="md:flex justify-between items-center mb-6">
                    <div className="md:flex  items-center md:space-x-10">
                        ...
                        <CSVLink filename="produtslist.csv" data={csvData}>
                            <Button
                                className={'normal-case'}
                                size="medium"
                                        ...
                                        <div>
                                            ...
                                            <Select
                                                ...
                                                options={[
                                                    {
                                                        value: 1,
                                                        label: PLAN_TYPE.MONTHLY,
                                                    },
                                                    {
                                                        value: 2,
                                                        label: PLAN_TYPE.YEARLY,
                                                    },
                                                ]}
                                                onChange={(e) =>
                                                    setNewPlan((newPlan) => ({
                                        ...
                                        <div>
                                            ...
                                            <Select
                                                ...
                                                options={[
                                                    {
                                                        value: 1,
                                                        label: PLAN_STATUS.ACTIVE,
                                                    },
                                                    {
                                                        value: 2,
                                                        label: PLAN_STATUS.DISABLED,
                                                    },
                                                ]}
                                                onChange={(e) =>
                                                    setNewPlan((newPlan) => ({
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            ...
                                            setLeftPlans(
                                                plans?.filter(
                                                    (plan) =>
                                                        !allSelectedDeletedIds?.includes(
                                                            plan.id
                                                        )
                                                )
                                            );
