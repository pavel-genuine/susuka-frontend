        ...
        <div className="lg-inner-column">
          <div className="left-column relative z-[1]">
            <div className="max-w-[520px] pt-20 ltr:pl-20 rtl:pr-20">
              ...
              <h4>
                Unlock your Project
                <br /><span className="text-slate-800 dark:text-slate-400 font-bold">
                  performance
                </span>
              </h4>
            </div>
          ...
          <div className="right-column relative bg-white dark:bg-slate-800">
            <div className="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
              <div className="auth-box h-full flex flex-col justify-center">
                ...
                <div className="text-center 2xl:mb-10 mb-5">
                  ...
                  <div className="text-slate-500 dark:text-slate-400 text-base">
                    Create an account to start using Geniematic.
                  </div>
                </div>
                <RegForm />
              ...
              <div className="auth-footer text-center">
                Copyright 2023, Geniematic All Rights Reserved.
              </div>
            </div>
          </div>
        </div>
