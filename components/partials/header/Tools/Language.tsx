...
import { LanguageContext } from '@/i18n/I18Provider';

const months = [
    { name: 'En', image: '/assets/images/flags/usa.png', locale: 'en' },
    { name: 'Gn', image: '/assets/images/flags/gn.png', locale: 'de' },
];
...
const Language = () => {
    ...
    useEffect(() => {
        localStorage.setItem('PREFERRED_LANGUAGE', selected.locale);
